    ...
    public class Shooter : ShooterBase
    {
        ...
        public override void ShootBullet()
        {
            if (Ammo > 0)
            {
                ...
                instantiatedProjectile.GetComponentInChildren<MeshRenderer>().material = ship.Avatar.AvatarData.ColorSets[ship.Avatar.AvatarData.ColorSetIndex].Color.PinMaterial;
